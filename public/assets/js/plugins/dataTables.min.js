...
!(function (n) {
                ...
                : ((X = void 0 === (H = e)),
                  ...
                  this.each(function () {
                      ...
                      if ("table" != this.nodeName.toLowerCase())
                          ...
                          (null !== e && "" !== e) ||
                              ((e = "DataTables_Table_" + $.ext._unique++),
                              (this.id = e));
                              ...
                              O = function () {
                                  ...
                                  var t = o.children("caption"),
                                      ...
                                      t =
                                          (0 === t.length &&
                                              (t =
                                                  B("<tbody/>").insertAfter(h)),
                                          (u.nTBody = t[0]),
                                          o.children("tfoot"));
                                  if (
                                      (0 === t.length &&
                                          (t = B("<tfoot/>").appendTo(o)),
                                      (u.nTFoot = t[0]),
                ...
                : ((f = function (e, t, n) {
                      ...
                      if ("" !== n)
                          for (var i = de(n), l = 0, s = i.length; l < s; l++) {
                              if (
                                  ((d = i[l].match(ce)), (a = i[l].match(p)), d)
                              ) {
                                  if (
                                      ((i[l] = i[l].replace(ce, "")),
                                      "" !== i[l] && (e = e[i[l]]),
    ...
    function ge(e, t, n, a) {
        ...
        return (
            t && (t = t.getAttribute("id")) && m(e.rowId)(a, t),
            { data: a, cells: u }
        );
    }
    function me(e, t) {
    ...
    function ve(e, t, n, a) {
        ...
        if (null === c.nTr) {
            for (
                ...
                (i = e.aoColumns[l]),
                    (o = (u = !n) ? _.createElement(i.sCellType) : a[l]) ||
    ...
    function ye(e, t) {
        ...
        if (l) {
            if (
                0 === B("th, td", l).length &&
                ("header" === t || h(e.aoColumns, s).join(""))
            )
                for (
                    r = B("<tr/>").appendTo(l), n = 0, a = i.length;
                    n < a;
                    n++
                )
                    B("<th/>")
    ...
    function Te(e, t, n) {
        for (
                    ...
                    (B.each(t, function (e, t) {
                        ...
                        null === t ||
                            ...
                            B.isPlainObject(t)
                                ...
                                : (e[n] = { contents: t }),
                            Array.isArray(e[n].contents)) ||
                            (e[n].contents = [e[n].contents]);
                    }),
                    Object.keys(a)
                        .map(function (e) {
            ...
            r[i].val.full &&
                (o.push({ full: r[i].val.full }),
                we(e, o[o.length - 1]),
                delete r[i].val.full),
                Object.keys(r[i].val).length &&
                    (o.push(r[i].val), we(e, o[o.length - 1]));
        return o;
    }
    function we(o, i) {
        function l(e, t) {
        ...
        var r,
            ...
            l =
                    ...
                    delete o.data),
                {
                    ...
                    error: function (e, t) {
                        -1 ===
                            ee(n, null, "xhr", [n, null, n.jqXHR], !0).indexOf(
                                !0
                            ) &&
                            ("parsererror" == t
              ...
              "ssp" != (i = te(n)) &&
                  ("ajax" == i
                      ? Ie(n, {}, function (e) {
                            ...
                            (n.iInitDisplayStart = l), c(n), w(n, !1), ke(n);
                        })
                      : (ke(n), w(n, !1))))
            : setTimeout(function () {
                  Oe(n);
            ...
            : ((e.scrollBarVis = p),
              ...
              f &&
                  B("th, td", n).each(function () {
                      B(this)
                          .children()
                          .wrapAll('<div class="dt-scroll-sizing">');
                  }),
              (c =
    ...
    function Ue(e, t, n) {
        ...
        return (
            void 0 === t && ((e.bSorted = !0), ee(e, null, "order", [e, c])), u
        );
    }
    function $e(e) {
        var t,
        ...
        if (l.bSort && l.bSortClasses) {
            for (t = 0, n = r.length; t < n; t++)
                (a = r[t].src),
                    B(h(e.aoData, "anCells", a)).removeClass(
                        o + (t < 2 ? t + 1 : 3)
                    );
            for (t = 0, n = i.length; t < n; t++)
                (a = i[t].src),
                    B(h(e.aoData, "anCells", a)).addClass(
                        o + (t < 2 ? t + 1 : 3)
                    );
        }
        e.aLastSort = i;
    ...
    function Ye(n, e, t) {
        ...
        if (e && e.time) {
            ...
            if (0 < l && e.time < +new Date() - 1e3 * l) n._bLoadingState = !1;
                ...
                -1 !==
                ee(n, "aoStateLoadParams", "stateLoadParams", [n, e]).indexOf(
                    !1
                )
            )
                n._bLoadingState = !1;
                ...
                if (
                    ...
                    void 0 !== e.search &&
                        B.extend(n.oPreviousSearch, e.search),
                    e.columns)
                ) {
                    for (a = 0, r = e.columns.length; a < r; a++) {
                        ...
                        void 0 !== s.visible &&
                            ...
                            void 0 !== s.search &&
                                B.extend(n.aoPreSearchCols[a], s.search);
                    }
                    i && i.columns.adjust();
                }
                (n._bLoadingState = !1),
    ...
    function Z(e, t, n, a) {
        if (
            ...
            if ((e && ee(e, null, "dt-error", [e, a, n], !0), "alert" == t))
                alert(n);
            else {
        ...
        (U.register = t =
            function (e, t) {
                if (Array.isArray(e))
                    ...
                    for (
                        var r = e.split("."), o = et, i = 0, l = r.length;
                        i < l;
                        i++
                    ) {
                        var s,
        ...
        t("ajax.url()", function (t) {
            ...
            return void 0 === t
                ? 0 === e.length
                    ? void 0
                    : ((e = e[0]),
                      B.isPlainObject(e.ajax) ? e.ajax.url : e.ajax)
                : this.iterator("table", function (e) {
        ...
        if (n.length && e.length) {
            ...
            if (a._details) {
                ...
                var i = n[0],
                    ...
                    l = i.aoData;
                if (
                    (r.off(t + " " + e + " " + a), h(l, "_details").length > 0)
                ) {
                    r.on(t, function (e, t) {
                        if (i !== t) return;
                        r.rows({ page: "current" })
                    ...
                    this.iterator("row", function (e, t) {
                        var n = e.aoData,
                            ...
                            r =
                                ...
                                -1 !== (r = e.aiDisplay.indexOf(t)) &&
                                    e.aiDisplay.splice(r, 1),
        ...
        gt =
                                ...
                                function (n) {
                                    ...
                                    if ("function" == typeof n)
                                        return (
                                            (a = ct(i, l)),
                                            s.map(function (e, t) {
                                                return n(t, st(i, t, 0, 0, a))
                                                    ? t
                                                    : null;
                                            })
                                        );
                                    var r =
                                        "string" == typeof n ? n.match(mt) : "";
                                    if (r)
                                        switch (r[2]) {
                                            case "visIdx":
                                            case "visible":
            ...
            ($.isDataTable = function (e) {
                ...
                return (
                    ...
                    (B.each($.settings, function (e, t) {
                        var n = t.nScrollHead
                                ? B("table", t.nScrollHead)[0]
                                : null,
                            a = t.nScrollFoot
                                ? B("table", t.nScrollFoot)[0]
                                : null;
            ...
            ($.defaults = {
                ...
                oLanguage: {
                    ...
                    sInfo: "Menampilkan _START_ sampai _END_ dari _TOTAL_ _ENTRIES-TOTAL_",
                    sInfoEmpty: "Menampilkan 0 sampai 0 dari 0 _ENTRIES-TOTAL_",
                    sInfoFiltered: "(Tersaring dari _MAX_ total _ENTRIES-MAX_)",
                    sInfoPostFix: "",
                    sDecimal: "",
                    sThousands: ",",
                    sLengthMenu: "_MENU_ _ENTRIES_ per halaman",
                ...
                _: function (e, t, n, a, r) {
                    ...
                    return (
                        ...
                        r && o.push(e.disabled),
                        {
                            display: (a =
                                "ellipsis" === t
                                    ? B('<span class="ellipsis"></span>').html(
                                          n
                                      )[0]
                                    : B("<button>", {
                                          class: o.join(" "),
    ...
    function At(e, t, n) {
        ...
        return (
            t <= n
                ...
                : (t - 1 - r <= e
                      ? (a = f(t - (n - 2), t))
                      : ((a = f(e - r + 2, e + r - 1)).push("ellipsis", t - 1),
                        a)
                  ).unshift(0, "ellipsis"),
            a
        );
                ...
                function n() {
                    !(function e(t, n, a) {
                        ...
                        h.length &&
                            1 < a.numbers &&
                            B(n).outerHeight() >=
                                2 * B(h[0]).outerHeight() - 10 &&
                            e(
                                t,
                                n,
                                B.extend({}, a, { numbers: a.numbers - 2 })
                            );
                    })(e, a, t);
                }
